        ...
        <AppSidebarLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-foreground text-2xl font-bold">Edit Product: {product.name}</h1>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                {imagePreview && (
                                    <div className="mt-2">
                                        <img src={imagePreview} alt="Product preview" className="h-32 w-32 rounded-md object-cover" />
                                    </div>
                                )}
                            </div>
